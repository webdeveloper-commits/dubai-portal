...
import { FaqAccordion, LeadForm, PrimeLocationMap } from "./ClientComponents";
            ...
            {area.agent_name && (
              ...
              >
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                  ...
                  {area.agent_phone && (
                    <a
                      href={`https://wa.me/${area.agent_phone.replace(/[^0-9]/g, "")}?text=${encodeURIComponent(`Hi, I'm interested in ${area.name}`)}`}
                      target="_blank"
                      rel="noreferrer"
                      style={{
                        display: "flex",
